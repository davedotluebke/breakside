...
└── images/                  # App icons and logos
    ...
    ├── favicon-*.png, favicon.ico  # App icons: generated by scripts/make-icons.py
    └── staging/                # Same icons on the staging purple
```
