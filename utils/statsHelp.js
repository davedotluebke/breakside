...
const STATS_COLUMN_HELP = {
    ...
    'O +/-':    { name: 'Plus / Minus on Offense',
                  desc: 'Plus/minus counting only points that started on offense — the O-line half of the player\'s +/-. Adds up with D +/- to the overall +/-.' },
    '..per O pt': { name: '+/- per Offensive Point',
                  desc: 'Plus/minus on points that started on offense, divided by how many of those points the player was on for.' },
    'D +/-':    { name: 'Plus / Minus on Defense',
                  desc: 'Plus/minus counting only points that started on defense — the D-line half of the player\'s +/-. Adds up with O +/- to the overall +/-.' },
    '..per D pt': { name: '+/- per Defensive Point',
                  desc: 'Plus/minus on points that started on defense, divided by how many of those points the player was on for. Breaking is hard, so a D-line rate near zero is a good one.' },
    'Pulls':    { name: 'Pulls',
