...
try:  # Both import modes — see routers/_shared.py.
    ...
    from breakside_server import config
    from breakside_server.storage import invite_storage, player_storage, share_storage
    from breakside_server.storage.file_utils import atomic_write_json
    from breakside_server.storage.event_storage import delete_event, list_team_events
    from breakside_server.storage.game_storage import (
        delete_game,
        list_all_games,
        list_game_versions,
    )
    from breakside_server.storage.index_storage import get_team_games, rebuild_index
    from breakside_server.storage.invite_storage import delete_invite, list_team_invites
    from breakside_server.storage.membership_storage import (
        delete_membership,
        get_team_memberships,
        get_user_memberships,
    )
    ...
    from breakside_server.storage.user_storage import delete_user, get_user
...
def _memberships_dir():
    try:
        ...
        from breakside_server.storage import membership_storage
