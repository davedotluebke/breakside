...
test('nulls the Team-E-shaped zombie: unconcluded non-last point running since November', () => {
...
test('nulls a concluded point even when it is the last point', () => {
    // Team-E points 2–13 shape: old updateScore stamped score time as
...
test('full Team-E replay: every stored marker is repaired, banked times survive', () => {
    // Shape of the real 2025-11-16 Team D vs Team E game as stored:
